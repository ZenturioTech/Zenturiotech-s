    ...
    >
      ...
      <div style={{ minWidth: 200, flex: '1 1 220px', display: 'flex', flexDirection: 'column', alignItems: 'flex-start', gap: 12}}>
        ...
        <div style={{ display: 'flex', gap: 16, zIndex: 1 }}>
          ...
          <a href="https://www.facebook.com/profile.php?id=61563813914814#" 
            ...
            <Image src="/images/f.png" alt="Facebook" width={32} height={32} style={{ borderRadius: '8px', background: '#14325a', padding: '0px' }} />
          </a>
          {/* Instagram */}
          <a href="https://www.instagram.com/zenturiotech/" 
            ...
            target="_blank" 
            rel="noopener noreferrer">
            <Image src="/images/i.png" alt="Instagram" width={32} height={32} style={{ borderRadius: '8px', background: '#14325a', padding: '0px' }} />
          </a>
          {/* LinkedIn */}
          <a href="https://www.linkedin.com/company/zenturiotech" 
            ...
            target="_blank" 
            rel="noopener noreferrer">
            <Image src="/images/l.png" alt="LinkedIn" width={32} height={32} style={{ borderRadius: '8px', background: '#14325a', padding: '0px' }} />
          </a>
          {/* X (Twitter) */}
          <a href="https://x.com/zenturiotech" 
            ...
            target="_blank" 
            rel="noopener noreferrer">
            <Image src="/images/x.png" alt="X" width={32} height={32} style={{ borderRadius: '8px', background: '#14325a', padding: '0px' }} />
          </a>
        </div>
      </div>
      ...
      <div style={{ minWidth: 200, flex: '1 1 220px', display: 'flex', flexDirection: 'column', alignItems: 'flex-start', gap: 12 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 8, color: '#072549', fontWeight: 300 }}>
          ...
          <a href="mailto:contact@zenturiotech.com">contact@zenturiotech.com</a>
        </div>
        <div style={{ display: 'flex', alignItems: 'center', gap: 8, color: '#072549', fontWeight: 300 }}>
          ...
          <a href="tel:+918129993666">+91-8129993666</a>
        </div>
      </div>
      ...
      <div style={{ minWidth: 160, flex: '1 1 180px', display: 'flex', flexDirection: 'column', alignItems: 'flex-start', gap: 12 }}>
        ...
        <div style={{ color: '#072549', fontWeight: 300, opacity: 0.92 }}>
          ...
          <a href="/services/gaming" style={{ color: '#000' }}>Gaming</a><br />
      ...
      <style jsx global>{`
        ...
        /* Underline on hover for all black text links in footer */
        .footer-container a[href^="/"],
        .footer-container a[href^="mailto"],
        .footer-container a[href^="tel"],
        .footer-container a[href*="web"],
        .footer-container a[href*="gaming"] {
          color: #000;
        ...
        .footer-container a[href*="web"]:hover,
        .footer-container a[href*="gaming"]:hover {
